<template>
  <div class = "commandbar-filter-menu">
    <button
      type = "button"
      @focus = "openDropdown"
      @blur = "closeDropdown">
  ...
  <!-- <div class = "filelist-menu">
    ...
    <div class = "filelist-menu-dropdown" v-show = "dropdownDisplay">
      <ul>
        <li v-show = "type === 'file'">
          <button type = "button" class = "dropdown-button" @click = "downloadFile">
            <img :src = "'/src/assets/icons/file_download_black_24dp.svg'"/>
            <label>Download</label>
          </button>
        </li>
        <li>
          <button type = "button" class = "dropdown-button" @click = "moveFile">
            <img :src = "'/src/assets/icons/drive_file_move_black_24dp.svg'"/>
            <label>Move</label>
          </button>
        </li>
        <li>
          <button type = "button" class = "dropdown-button" @click = "deleteFile">
